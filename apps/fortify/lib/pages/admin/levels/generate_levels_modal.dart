...
class GenerateLevelsModal extends StatefulWidget {
  final Future<void> Function({required int count, required String model, String? guidance}) onGenerate;

  const GenerateLevelsModal({super.key, required this.onGenerate});
  ...
  static Future<bool?> show(
    ...
    return showDialog<bool>(
      ...
      builder: (BuildContext context) => GenerateLevelsModal(onGenerate: onGenerate),
    );
  }

  @override
  State<GenerateLevelsModal> createState() => _GenerateLevelsModalState();
}

class _GenerateLevelsModalState extends State<GenerateLevelsModal> {
      ...
      child: AlertDialog(
        ...
        title: Row(
          children: <Widget>[
            ...
            const Text('Generate Levels', style: TextStyle(color: AdminColors.onSurface)),
          ],
        ),
        content: SizedBox(
          width: 400,
          child: Column(
            ...
            children: <Widget>[
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Number of levels', helperText: 'Between 1 and 20'),
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'e.g., Focus on earthquake preparedness themes',
