      ...
      'properties': <String, dynamic>{
        'levels': <String, dynamic>{
          ...
          'items': <String, dynamic>{
            'type': 'object',
            'properties': <String, dynamic>{
              'level': <String, dynamic>{'type': 'integer'},
              'title': <String, dynamic>{'type': 'string'},
              'description': <String, dynamic>{'type': 'string'},
              'icon': <String, dynamic>{'type': 'string'},
              'xpThreshold': <String, dynamic>{'type': 'integer'},
            },
            'required': <String>['level', 'title', 'description', 'icon', 'xpThreshold'],
...
Future<List<Map<String, dynamic>>> callOpenAI(String apiKey, String model, String userPrompt) async {
  ...
  final List<dynamic> levels = parsed['levels'] as List<dynamic>? ?? <dynamic>[];
